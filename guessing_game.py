   ...
   # using the else statement to keep running the program once exceptions are raised and handled
      ...
      # added the current value of current attempts to the accrued(accummulated) attempts for all rounds
        ...
        if play_again.lower() == 'yes' or play_again.lower() == 'y':
          ...
          attempts_mean=mean(accrued_attempts)
          attempts_median=median(accrued_attempts)
          attempts_mode=mode(accrued_attempts)
          print(f''' 
                this is the mean of the attemps: {attempts_mean}
                this is the median of the attempts:{attempts_median}
                this is the attempts_mode: {attempts_mode}
